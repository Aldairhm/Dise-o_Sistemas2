        <div id="mobile-menu" class="hidden lg:hidden border-t border-gray-100 bg-white">
            <nav class="flex flex-col px-4 pt-2 pb-4 space-y-2">
                ...
                <a href="{{ route('productos.index') }}" class="text-sm font-medium text-gray-600 hover:text-blue-600 flex items-center gap-2 p-2 rounded-lg hover:bg-gray-50 transition-colors"><i class="fas fa-shopping-bag w-5 text-center"></i> Productos</a>
