                        ...
                        <div class="grid grid-cols-1 md:grid-cols-12 gap-8">
                            ...
                            <div class="md:col-span-8 flex flex-col">
                                ...
                                <div class="space-y-5 flex-1">
                                    ...
                                    <!-- Descripción -->
                                    <div>
                                        <label for="inputDescripcion" class="block text-sm font-bold text-slate-700 mb-1.5">Descripción <span class="text-red-500">*</span></label>
                                        ...
                                        <p class="mt-1.5 text-xs text-slate-400">Breve resumen de lo que incluye esta categoría (Campo obligatorio).</p>
